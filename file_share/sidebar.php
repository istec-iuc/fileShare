  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <div class="dropdown">
      ...
      <div class="dropdown-menu" style="">
        <a class="dropdown-item manage_account" href="javascript:void(0)" data-id="<?php echo $_SESSION['login_id'] ?>">Yönetim hesabı</a>
        <div class="dropdown-divider"></div>
        <a class="dropdown-item" href="ajax.php?action=logout">Çıkış</a>
      </div>
    </div>
    <div class="sidebar">
      <nav class="mt-2">
        ...
        <?php if($_SESSION['login_type'] == 1): ?>
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./index.php?page=Kullanici_listesi" class="nav-link nav-user_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Listele</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./index.php?page=Dosya_listesi" class="nav-link nav-Dosya_listesi tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>listele</p>
                </a>
              </li>
