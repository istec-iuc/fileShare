	...
	<div class="card card-outline card-primary">
                  ...
                  <div id="" class="row mt-2 dz-processing dz-success dz-complete">
                      ...
                      <div class="col d-flex align-items-center">
                          <p class="mb-0">
                            ...
                            (<span><strong><?php echo filesize('assets/uploads/'.$v) ?></strong> Byte</span>)
                          </p>
                          <strong class="error text-danger" data-dz-errormessage=""></strong>
                      </div>
                      <div class="col-4 d-flex align-items-center">
    	...
    	<div class="card-footer border-top border-info">
    		<div class="d-flex w-100 justify-content-center align-items-center">
    			<button class="btn btn-flat  bg-gradient-primary mx-2" form="manage-upload">Kaydet</button>
    			<button class="btn btn-flat bg-gradient-secondary mx-2" type="button">Iptal</button>
    		</div>
    	</div>
	</div>
</div>
...
$(function () {
  ...
  var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
    ...
    acceptedFiles:'application/pdf,.rar,.zip,.doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document',
  ...
  myDropzone.on("success",function(file,resp){
	...
	$('#manage-upload').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					alert_toast('Dosya başarıyla kaydedildi',"success");
					setTimeout(function(){
						location.href = 'index.php?page=Dosya_listesi'
					},2000)
				}
			}
		})
